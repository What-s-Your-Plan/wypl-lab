				...
				.andDo(document("schedule/getSchedule",
						...
						responseFields(
								...
								fieldWithPath("body.description").type(JsonFieldType.STRING)
										.optional()
										.description("조회된 일정의 설명"),
								fieldWithPath("body.start_date").type(JsonFieldType.STRING)
										.description("조회된 일정의 시작 날짜와 시간"),
								fieldWithPath("body.end_date").type(JsonFieldType.STRING)
										.description("조회된 일정의 끝 날짜와 시간"),
								fieldWithPath("body.category").type(JsonFieldType.STRING)
										.description("조회된 일정의 종류(그룹인지 개인인지)"),
		...
		resultActions.andDo(print())
				.andDo(document("schedule/createSchedule",
						...
						responseFields(
								...
								fieldWithPath("body.description").type(JsonFieldType.STRING)
										.optional()
										.description("생성된 일정의 설명"),
								fieldWithPath("body.start_date").type(JsonFieldType.STRING)
										.description("생성된 일정의 시작 날짜와 시간"),
								fieldWithPath("body.end_date").type(JsonFieldType.STRING)
										.description("생성된 일정의 끝 날짜와 시간"),
								fieldWithPath("body.category").type(JsonFieldType.STRING)
										.description("생성된 일정의 종류(그룹인지 개인인지)"),
								fieldWithPath("body.group_id").type(JsonFieldType.NUMBER)
										.optional()
