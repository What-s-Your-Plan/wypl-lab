...
public class ScheduleRepositoryTest {
	...
	void createSchedule() {
		//given
		Schedule schedule = ScheduleFixture.PERSONAL_EXERCISE_SCHEDULE.toScheduleRequest().toEntity();
		...
		assertThat(savedSchedule.getOwnerId()).isEqualTo(schedule.getOwnerId());
	}
}
