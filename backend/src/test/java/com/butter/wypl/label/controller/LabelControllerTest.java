		...
		resultActions.andDo(print())
				.andDo(document("label/getLabels",
						...
						responseFields(
								...
								fieldWithPath("body.labels[].member_id").type(JsonFieldType.NUMBER)
										.description("라벨 주인의 인덱스"),
								fieldWithPath("body.labels[].label_id").type(JsonFieldType.NUMBER)
										.description("라벨의 인덱스"),
	...
	void getAllLabel() throws Exception {
		...
		resultActions.andDo(print())
				.andDo(document("label/getAllLabel",
						...
						responseFields(
								fieldWithPath("message").type(JsonFieldType.STRING).description("응답 메세지"),
								fieldWithPath("body.label_count").type(JsonFieldType.NUMBER)
										.description("라벨과 그룹의 총 개수"),
								fieldWithPath("body.labels[].id").type(JsonFieldType.NUMBER)
										.description("라벨이나 그룹의 아이디"),
								fieldWithPath("body.labels[].category").type(JsonFieldType.STRING).description("타입"),
								fieldWithPath("body.labels[].title").type(JsonFieldType.STRING)
										.description("라벨이나 그룹의 제목"),
								fieldWithPath("body.labels[].color").type(JsonFieldType.STRING)
										.description("라벨이나 그룹의 색상")
						)
				))
				.andExpect(status().isOk());
